	...
	public:
		     ...
		     inline double   uniformQuantile(double a, double b, double p);                                /*!< quantile of a uniform(a,b) distribuiton */
		            ...
		            double   betaQuantile(double a, double b, double p);                                   /*!< quantile of the Beta distribution */
					  void   dirichletRv(const MbVector<double> &a, double *z);            /* dirichlet */ /*!< Dirichlet random variable */
		            double   dirichletPdf(const MbVector<double> &a, double *z);                           /*!< Dirichlet probability density */
		            double   lnDirichletPdf(const MbVector<double> &a, double *z);		                   /*!< natural log of Dirichlet probability density */
