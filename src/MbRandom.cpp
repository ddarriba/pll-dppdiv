 ...
 * \throws Does not throw an error.
 */
void MbRandom::dirichletRv(const MbVector<double> &a, double *z) {
 ...
 */
double MbRandom::dirichletPdf(const MbVector<double> &a, double *z) {
 ...
 * \throws Does not throw an error.
 */
double MbRandom::lnDirichletPdf(const MbVector<double> &a, double *z) {
